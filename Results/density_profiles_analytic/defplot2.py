...
ax1.text(0.02, 0.95, r'$r_d = 250 R_s$', transform=ax1.transAxes, fontsize=12, va='top')
...
ax2.text(0.02, 0.95, r'$r_d = 2.5 R_s$', transform=ax2.transAxes, fontsize=12, va='top')
...
ax3.text(0.02, 0.95, r'$r_d = 0.25 R_s$', transform=ax3.transAxes, fontsize=12, va='top')
...
fig6 = mp.figure()
#You must select the correct size of the plot in advance
fig6.set_size_inches(3.54,height*3.54) 
