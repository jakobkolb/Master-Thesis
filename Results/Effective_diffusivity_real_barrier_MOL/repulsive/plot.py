...
for i in range(5):
        k+=1
        tmp[:,0] = np.loadtxt('rep' + `i` + '/effective_d_profile.tsv')
...
l0 = d_ax.plot(r_n[2:-1], d_n[2:-1,1], 'r-', label = r'$r_d = 10^{-3}$')
#l1 = d_ax.plot(r_n[2:-1], d_n[2:-1,2], 'r:', label = r'$r_d = 10^{-2}$')
l2 = d_ax.plot(r_n[2:-1], d_n[2:-1,3], 'r:', label = r'$r_d = 10^{-1}$')
l3 = d_ax.plot(r_n[2:-1], d_n[2:-1,4], 'r-.', label = r'$r_d = 2.5$')
l4 = d_ax.plot(r_n[2:-1], d_n[2:-1,5], 'r--', label = r'$r_d = 100$')
