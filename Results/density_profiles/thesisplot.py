...
ax4.text(0.02, label_height, 'D)', transform=ax1.transAxes, fontsize=12, va='top')
...
ax5.text(label_width, label_height, 'E)', transform=ax2.transAxes, fontsize=12, va='top')
...
fig6 = mp.figure()
#You must select the correct size of the plot in advance
fig6.set_size_inches(3.81,height*3.54) 
ax6 = fig6.add_subplot(111)
ax6.text(label_width, label_height, 'F)', transform=ax3.transAxes, fontsize=12, va='top')
