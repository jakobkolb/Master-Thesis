...
ax1b = ax1.twinx()
l1 = ax1.plot(rep_data[0][1:-1,0], rep_data[0][1:-1,3], zorder = 2, color = '#CC0000', label = r'$r_d = 0.25$')
l2 = ax1.plot(rep_data[1][1:-1,0], rep_data[1][1:-1,3], zorder = 3, color = '#FF3333', label = r'$r_d = 2.5$')
l3 = ax1.plot(rep_data[2][1:-1,0], rep_data[2][1:-1,3], zorder = 4, color = '#FF9999', label = r'$r_d = 250$')
...
l1 = ax2.plot(rep_data[0][1:-1,0], rep_data[0][1:-1,1], zorder = 2, color = '#0080FF', label = r'$r_d = 0.25$')
l2 = ax2.plot(rep_data[1][1:-1,0], rep_data[1][1:-1,1], zorder = 3, color = '#66B2FF', label = r'$r_d = 2.5$')
l3 = ax2.plot(rep_data[2][1:-1,0], rep_data[2][1:-1,1], zorder = 4, color = '#99CCFF', label = r'$r_d = 250$')
...
ax3b = ax3.twinx()
l1 = ax3.plot(att_data[0][1:-1,0], att_data[0][1:-1,3], zorder = 2, color = '#CC0000', label = r'$r_d = 0.25$')
l2 = ax3.plot(att_data[1][1:-1,0], att_data[1][1:-1,3], zorder = 3, color = '#FF3333', label = r'$r_d = 2.5$')
l3 = ax3.plot(att_data[2][1:-1,0], att_data[2][1:-1,3], zorder = 4, color = '#FF9999', label = r'$r_d = 250$')

ax3.text(0.02, 0.95, 'A)', zorder = 5, transform=ax3.transAxes, fontsize=12, va='top')
l4 = ax3b.plot(att_data[0][:,0], att_data[0][:,4], '--', zorder = 6, color = '#A0A0A0', label = r'$U_m(r)$')
...
l1 = ax4.plot(att_data[0][1:-1,0], att_data[0][1:-1,1], zorder = 2, color = '#0080FF', label = r'$r_d = 0.25$')
l2 = ax4.plot(att_data[1][1:-1,0], att_data[1][1:-1,1], zorder = 3, color = '#66B2FF', label = r'$r_d = 2.5$')
l3 = ax4.plot(att_data[2][1:-1,0], att_data[2][1:-1,1], zorder = 4, color = '#99CCFF', label = r'$r_d = 250$')

ax4.text(0.02, 0.95, 'B)', zorder = 5, transform=ax4.transAxes, fontsize=12, va='top')
l4 = ax4b.plot(att_data[0][:,0], att_data[0][:,4], '--', zorder = 6, color = '#A0A0A0', label = r'$U_m(r)$')
