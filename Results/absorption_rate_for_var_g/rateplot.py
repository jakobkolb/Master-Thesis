...
asrate_max = [1.3,1.3,1.3,1.5]
alrate_max = [1.07,1.06,1.05,1.05]

rsrate_max = [2,2,2,1.5]
rlrate_max = [1.5,1.5,1.5,1.2]
...
ax2.annotate('increasing $g$', xy=(10**0, 1.1),  xycoords='data',
