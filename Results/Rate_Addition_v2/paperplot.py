...
if False:
    ...
    ax2.text(0.02, 0.95, '$k_{surf} = $'+Ksvals[i], transform=ax2.transAxes, fontsize=12, va='top')
    ...
    ax3.text(0.02, 0.95, '$k_{surf} = $'+Ksvals[i], transform=ax3.transAxes, fontsize=12, va='top')
