...
#    Knum_rep[i] = N_tmp_rep
    ax1.plot(Knum_att[i][:,0],Knum_att[i][:,1], 'o', label = r'$K_s = $'+k)
...
ax1.plot(Keff_att[i][:,0],Keff_att[i][:,1], '-',color = reds[i], label = r'$K_{eff}$')
ax1.plot(Kbc_att[i][:,0],Kbc_att[i][:,1], '-.', color = reds[i], label = r'$K_{bc}$')    
ax1.plot(Knum_att[i][:,0],Knum_att[i][:,1], 'o',color = blues[i], label = r'$K_N$')
ax1.set_xscale('log')
mp.legend()
...
ax2.plot(Keff_att[i][:,0],Keff_att[i][:,1], '-',color = reds[i], label = r'$K_{eff}$')
ax2.plot(Kbc_att[i][:,0],Kbc_att[i][:,1], '-.', color = reds[i], label = r'$K_{bc}$')   
ax2.plot(Knum_att[i][:,0],Knum_att[i][:,1], 'o',color = blues[i],  label = r'$K_N$')
ax2.set_xscale('log')
mp.legend()
...
ax3.plot(Keff_att[i][:,0],Keff_att[i][:,1], '-',color = reds[i], label = r'$K_{eff}$')
ax3.plot(Kbc_att[i][:,0],Kbc_att[i][:,1], '-.', color = reds[i], label = r'$K_{bc}$')   
ax3.plot(Knum_att[i][:,0],Knum_att[i][:,1], 'o',color = blues[i], label = r'$K_N$')
ax3.set_xscale('log')
mp.legend()
