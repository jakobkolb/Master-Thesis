...
for i in range(3):
    ...
    chart.add_node('Sink')
    chart.add_node('Bath')
    chart.add_node('BIi1', color='blue', shape='circle', label='in', width='0.5')
    chart.add_node('BIi0',color='red', shape='circle', label='in', width='0.5')
    chart.add_node('BIo1', color='blue', shape='circle', label='out', width='0.5')
    chart.add_node('BIo0',color='red', shape='circle', label='out', width='0.5')
    chart.add_node('BIIi1', color='blue', shape='circle', label='in', width='0.5')
    chart.add_node('BIIi0',color='red', shape='circle', label='in', width='0.5')
    chart.add_node('BIIo1', color='blue', shape='circle', label='out', width='0.5')
    chart.add_node('BIIo0',color='red', shape='circle', label='out', width='0.5')
