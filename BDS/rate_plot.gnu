...
plot "rate_data.out" u 1:2:3 every ::2::2 with yerrorbars title "measured rate", "rate_data.out" u 1:2:3 every ::3::3 with yerrorbars title "rate from density on boundary"
